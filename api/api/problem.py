...
problem_schema = Schema({
    ...
    "disabled": check(
        (0, "A problem's disabled state is either True or False.", [bool])),
    "autogen": check(
        (0, "A problem should either be autogenerated or not, True/False", [bool])),
...
def insert_problem(problem):
    ...
    if get_problem(name=problem["displayname"]) is not None or get_problem(pid=problem["pid"]) is not None:
