...
def insert_problem(problem):
    ...
    #TODO: We should not depend on exceptions for this
    try:
        get_problem(name=problem["displayname"])
        raise APIException(0, None, "Problem with identical displayname already exists.")
    except APIException:
        pass

    try:
        get_problem(pid=problem["pid"])
